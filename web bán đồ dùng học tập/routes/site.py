...
from auth_utils import current_user, get_current_account, require_auth
from db import fetch_all, fetch_one, get_db_connection
from routes.products import attach_image_url
...
@site_bp.route("/cart")
def cart():
    return render_template("user/cart.html", current_user=current_user())
