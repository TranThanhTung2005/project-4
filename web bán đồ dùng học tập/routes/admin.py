...
from auth_utils import current_user, require_auth, require_primary_admin, is_primary_admin
from db import fetch_all, fetch_one, get_db_connection
from services.admin_context import get_admin_context, get_product_column_names
from utils.admin_helpers import parse_form_datetime
...
def dashboard():
    return render_admin_page("admin/dashboard.html", "dashboard")


@admin_bp.route("/accounts")
@require_auth(role="admin")
def accounts_page():
    return render_admin_page("admin/accounts.html", "accounts")


@admin_bp.route("/products")
@require_auth(role="admin")
def products_page():
    return render_admin_page("admin/products.html", "products")


@admin_bp.route("/orders")
@require_auth(role="admin")
def orders_page():
    return render_admin_page("admin/orders.html", "orders")


@admin_bp.route("/catalog")
@require_auth(role="admin")
def catalog_page():
    return render_admin_page("admin/catalog.html", "catalog")


@admin_bp.route("/promotions")
@require_auth(role="admin")
def promotions_page():
    return render_admin_page("admin/promotions.html", "promotions")


@admin_bp.route("/users")
@require_auth(role="admin")
def users_page():
    return render_admin_page("admin/users.html", "users")


@admin_bp.route("/employees")
@require_auth(role="admin")
def employees_page():
    return render_admin_page("admin/employees.html", "employees")


@admin_bp.route("/suppliers")
@require_auth(role="admin")
def suppliers_page():
    return render_admin_page("admin/suppliers.html", "suppliers")
...
def create_product():
    ...
    try:
        ...
        if "ImageURL" in product_columns:
            ...
            insert_values.append(form.get("image_url") or None)
...
def update_product(product_id):
    ...
    try:
        ...
        if "ImageURL" in product_columns:
            ...
            update_values.append(form.get("image_url") or None)
        if "IsActive" in product_columns:
